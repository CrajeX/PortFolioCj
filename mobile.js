            ...
            images.forEach(img => {
                img.addEventListener('mouseenter', () => {
                    images.forEach(otherImg => {
                        if (otherImg === img) {
                            otherImg.style.opacity = highlightOpacity;
                        } else {
                            otherImg.style.opacity = otherOpacity;
                        }
                    });
                });
...
// Example usage
addHoverHighlightEffect(['hae', 'hye', 'han', 'min', 'dani'], '1', '0.5');
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (targetElement) {
            targetElement.addEventListener('mouseover', () => {
                ...
                document.body.style.backgroundSize = 'contain'; // Optional: ensure the image covers the body\
